...
//    private static final String encryptEncodeRules = "rxxg";// 定义默认加密规则
     ...
     */
    public static String invokeEncryptEncode(String content,String encryptEncodeRules) {
        String resultEncode = "";
        try {
     ...
     */
    public static String invokeDecryptEncode(String content,String encryptEncodeRules) {
        String resultEncode = "";
        try {
            KeyGenerator keyGenerator = KeyGenerator.getInstance("AES");
            SecureRandom random = SecureRandom.getInstance("SHA1PRNG");
