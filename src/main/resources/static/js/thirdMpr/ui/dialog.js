...
console.log(window.pageYOffset);
    viewerWidth = $('.mprContainer').width();
    viewerHeight = $('.mprContainer').height();
    ...
    top = scrollTop + (viewerHeight / 2) - (dialogHeOkight / 2) + "px";*/
...
papaya.ui.Dialog.prototype.showDialog = function () {
    ...
    html += "<div class='" + PAPAYA_DIALOG_BUTTON_CSS + "'><div type='button' id='" + this.id + "-Ok" +
        "'  >关闭</div></div></div>";
