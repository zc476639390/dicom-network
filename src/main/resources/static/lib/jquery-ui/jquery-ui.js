...
var mouseOffset=105;//helper相对鼠标的偏移位置
(function (factory) {
...
//>>css.structure: ../../themes/base/draggable.css
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseDrag: function (event, noPropagation) {
         ...
         /*   if (joinStruct._dragFlag) {
                this.position.left = event.clientX - mouseOffset;//修改拖动块与鼠标的相对位置 sj_20170831
                this.position.top = event.clientY - mouseOffset;
            }*/
            //songsong
        /*    this.position.left = event.clientX - mouseOffset;//修改拖动块与鼠标的相对位置 sj_20170831
            this.position.top = event.clientY - mouseOffset;*/
...
// console.log(this.element[0]);
    ...
    $.ui.plugin.add("draggable", "stack", {
        start: function (event, ui, instance) {
            ...
            this.css("zIndex", ( min + group.length ));//sj undo
            // var max=getMaxZindex();
            // console.log(max);
            //   this.css("zIndex", ( max+1 ));//点击图像z-index最大
        }
    });
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _updatePrevProperties: function () {
            console.log("_updatePrevProperties");
            this.prevPosition = {
        ...
        _updateVirtualBoundaries: function (forceAspectRatio) {
            console.log("_updateVirtualBoundaries");
        ...
        _getPaddingPlusBorderDimensions: function (element) {
            console.log("_getPaddingPlusBorderDimensions");
        ...
        _proportionallyResize: function () {
            console.log("_proportionallyResize");
